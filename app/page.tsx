import { MapPin, Star, Navigation, Quote, Clock, AlertTriangle, Compass, Camera, Info, ExternalLink } from "lucide-react";
...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-gray-200 font-sans selection:bg-white selection:text-black">
      {/* Hero Section */}
      <header className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-6 py-20 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-40">
          <img 
            src="https://images.unsplash.com/photo-1542103749-8ef59b94f47e?q=80&w=2000&auto=format&fit=crop" 
        ...
        <div className="relative z-10 max-w-4xl mx-auto mt-20">
          <p className="text-sm md:text-base tracking-[0.3em] uppercase text-gray-400 mb-6">
            Sur les traces du philosophe
          </p>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-light tracking-tight mb-6 text-white">
            Chemin de Nietzsche
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 font-light mb-10 flex items-center justify-center gap-4">
      ...
      <div className="max-w-5xl mx-auto px-6 py-24 space-y-32">
        ...
        <section className="text-center max-w-3xl mx-auto">
          <Quote className="w-12 h-12 text-gray-700 mx-auto mb-8 rotate-180" />
          <blockquote className="text-2xl md:text-3xl font-serif italic leading-relaxed text-gray-300 mb-6">
        ...
        <section className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl font-serif text-white">L'Esprit du Lieu</h2>
            ...
            <p className="text-gray-400 leading-relaxed text-lg font-light">
              C'est ici, lors de l'hiver 1883-1884, que le philosophe allemand Friedrich Nietzsche a trouvé la clarté mentale nécessaire pour composer la troisième partie de son œuvre majeure, <span className="text-gray-200 italic">Ainsi parlait Zarathoustra</span>. La rudesse du terrain rocailleux, combinée à la beauté absolue du paysage, incarne parfaitement sa philosophie du dépassement de soi.
            </p>
          </div>
        ...
        <section className="border border-gray-800 bg-[#111] p-10 md:p-16 rounded-sm">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-serif text-white mb-4">Préparer l'Ascension</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="space-y-3">
              ...
              <h3 className="text-white font-medium uppercase tracking-wider text-sm">Durée</h3>
              <p className="text-gray-400 text-sm">1h à 1h30 (Montée)<br/>45 min (Descente)</p>
            </div>
            <div className="space-y-3">
              <Compass className="w-6 h-6 text-gray-400" />
              <h3 className="text-white font-medium uppercase tracking-wider text-sm">Difficulté</h3>
              <p className="text-gray-400 text-sm">Moyenne à Difficile<br/>Fort dénivelé (400m)</p>
            </div>
            <div className="space-y-3">
              <AlertTriangle className="w-6 h-6 text-gray-400" />
              <h3 className="text-white font-medium uppercase tracking-wider text-sm">Terrain</h3>
              <p className="text-gray-400 text-sm">Rocailleux, marches inégales, escarpé</p>
            </div>
            <div className="space-y-3">
              <Camera className="w-6 h-6 text-gray-400" />
              <h3 className="text-white font-medium uppercase tracking-wider text-sm">Lumière</h3>
              <p className="text-gray-400 text-sm">Matin tôt (douceur)<br/>Fin d'après-midi (dorée)</p>
            </div>
          </div>

          <div className="grid md:grid-cols-2 gap-12 pt-12 border-t border-gray-800">
            <div>
              ...
              <ul className="space-y-4 text-gray-400 font-light">
                <li className="flex gap-3"><span className="text-gray-600">—</span> <strong>Chaussures :</strong> Baskets de trail ou chaussures de randonnée obligatoires. Pas de tongs !</li>
                <li className="flex gap-3"><span className="text-gray-600">—</span> <strong>Hydratation :</strong> Prévoyez au moins 1L d'eau par personne (aucun point d'eau sur le chemin).</li>
                <li className="flex gap-3"><span className="text-gray-600">—</span> <strong>Protection :</strong> Crème solaire et chapeau, le sentier est très exposé au soleil.</li>
              </ul>
            </div>
            <div>
              <h3 className="text-xl text-white mb-6 flex items-center gap-3">
              ...
              <ul className="space-y-4 text-gray-400 font-light">
                <li className="flex gap-3"><span className="text-gray-600">↑</span> <strong>La version philosophique :</strong> Montée depuis la gare d'Èze-sur-Mer. L'effort physique renforce l'expérience. Retour en bus.</li>
                <li className="flex gap-3"><span className="text-gray-600">↓</span> <strong>La version contemplative :</strong> Prenez le bus jusqu'au village d'Èze, visitez, puis redescendez à pied face à la mer. Plus facile pour le cardio, mais attention aux genoux.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="text-center mb-16">
            <h2 className="text-3xl font-serif text-white mb-4">Échos des Voyageurs</h2>
            <p className="text-gray-500">Expériences authentiques partagées par les marcheurs.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {REVIEWS.map((review) => (
              <div key={review.id} className="bg-[#161616] p-8 border border-gray-800 hover:border-gray-600 transition-colors flex flex-col">
                <div className="flex text-yellow-600 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className={`w-4 h-4 ${i < review.rating ? 'fill-current' : 'text-gray-700'}`} />
                  ))}
                </div>
                <p className="text-gray-400 font-light italic mb-6 flex-grow text-sm leading-relaxed">
                  "{review.text}"
                </p>
        ...
        <section className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent z-10 pointer-events-none md:w-1/2"></div>
          
          <div className="relative z-20 md:w-1/2 py-16 pr-8">
            <h2 className="text-3xl font-serif text-white mb-6">Accès & Carte</h2>
            ...
            <a 
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-white text-black text-sm uppercase tracking-widest hover:bg-gray-200 transition-colors"
            >
      ...
      {/* Footer */}
      <footer className="border-t border-gray-900 bg-black pt-16 pb-8 px-6 text-center text-sm">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 mb-12 text-gray-500">
          <div className="flex gap-6">
            ...
            <a href="#cookies" className="hover:text-white transition-colors">Paramètres des cookies</a>
          </div>
          <div>
            <p>Support technique : <a href="mailto:claritleonelmnicol@gmail.com" className="hover:text-white transition-colors underline decoration-gray-800 underline-offset-4">claritleonelmnicol@gmail.com</a></p>
          </div>
        </div>
        <p className="text-gray-600 font-serif tracking-widest">
